...
function program2(depth0,data) {
  ...
  data.buffer.push("hmm...\n\n");
  stack1 = (helper = helpers['ic-lazy-list'] || (depth0 && depth0['ic-lazy-list']),options={hash:{
    'href': ("http://example.com/users"),
    'data': ("users")
  },hashTypes:{'href': "STRING",'data': "ID"},hashContexts:{'href': depth0,'data': depth0},inverse:self.noop,fn:self.program(1, program1, data),contexts:[],types:[],data:data},helper ? helper.call(depth0, options) : helperMissing.call(depth0, "ic-lazy-list", options));
  if(stack1 || stack1 === 0) { data.buffer.push(stack1); }
  data.buffer.push("\n\n");
  return buffer;
